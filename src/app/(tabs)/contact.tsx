        ...
        >
          <View className={`${isMobile ? 'flex-col' : 'flex-row'} justify-around items-center w-full max-w-300`}>
            ...
            <View className={`${isMobile ? 'w-full my-5' : 'w-[45%]'} items-center justify-center`}>
              <ThemedText className="text-lg text-center max-w-130">I have come to love programming over the last few years. I enjoy the satisfaction of making a design and functionality work together. I also enjoy making games and look forward to making more Fortnite Experiences in my spare time soon.</ThemedText>
            </View>
            {/* Right side content */}
